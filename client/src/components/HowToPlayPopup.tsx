...
const slides = [
  ...
  },
  {
    ...
    tag: "Step 3",
    title: "Climb The\nLeaderboard",
    subtitle: "Daily. Annual.",
    description: "Two leaderboards running simultaneously. The more you predict, the more chances you have to win. Build your streak and dominate.",
    icon: TrendingUp,
    gradient: "from-emerald-500 via-green-500 to-teal-500",
    bgAccent: "bg-emerald-500/10",
    features: ["Daily Winner", "Annual Champion"],
  },
  {
    step: 4,
    tag: "Step 4",
