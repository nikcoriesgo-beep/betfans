...
const slides = [
  ...
  },
  {
    ...
    tag: "Step 4",
    title: "Win Real\nCash",
    subtitle: "Paid directly to your card.",
    description: "50% of all membership fees go into the live prize pool. Top predictors get paid out automatically to the same card they signed up with.",
    icon: DollarSign,
    gradient: "from-yellow-400 via-amber-500 to-orange-500",
    bgAccent: "bg-yellow-500/10",
    features: ["Live Prize Pool", "Daily Payouts", "Weekly Payouts", "Monthly Jackpot"],
  },
  {
    step: 5,
    tag: "Step 5",
